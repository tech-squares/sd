...
conzept::concept_descriptor conzept::unsealed_concept_descriptor_table[] = {
   ...
   {"@6 ARE AS COUPLES",                     concept_some_are_tandem,       F+D, l_a1,
    UC_none, 0, 0,                    0x100, tandem_key_cpls},
   {"@6 ARE TANDEM",                         concept_some_are_tandem,       F+D, l_c1,
    UC_none, 0, 0,                    0x100, tandem_key_tand},
   {"@6 ARE COUPLES OF 3",                   concept_some_are_tandem,       F+D, l_c1,
    UC_none, 0, 0,                    0x100, tandem_key_cpls3},
   {"@6 ARE TANDEMS OF 3",                   concept_some_are_tandem,       F+D, l_c1,
   ...
   {"COUPLES @b TWOSOME",                    concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_cpls},
   {"TANDEM @b TWOSOME",                     concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_tand},
   {"SIAMESE @b TWOSOME",                    concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_siam},
   {"COUPLES OF 3 @b THREESOME",             concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_cpls3},
   {"TANDEMS OF 3 @b THREESOME",             concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_tand3},
   {"SIAMESE OF 3 @b THREESOME",             concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_siam3},
   {"COUPLES OF 4 @b FOURSOME",              concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_cpls4},
   {"TANDEMS OF 4 @b FOURSOME",              concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_tand4},
   {"SIAMESE OF 4 @b FOURSOME",              concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_siam4},
   {"BOXES ARE SOLID @b BOXSOME",            concept_frac_tandem,           F+D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_box},
   {"DIAMONDS ARE SOLID @b DIAMONDSOME",     concept_frac_tandem,           F+D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_diamond},
   {"SKEW @b TWOSOME",                       concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_skew},
   {"GRUESOME AS COUPLES @b TWOSOME",        concept_gruesome_frac_tandem,    D, l_c4,
    UC_none, 0, CONCPROP__NEEDK_2X8,  0x022, tandem_key_cpls},
   {"GRUESOME TANDEM @b TWOSOME",            concept_gruesome_frac_tandem,    D, l_c4,
    UC_none, 0, CONCPROP__NEEDK_2X8,  0x022, tandem_key_tand},
   {"@6 ARE COUPLES @b TWOSOME",             concept_some_are_frac_tandem,  F+D, l_c4,
    UC_none, 0, 0,                    0x120, tandem_key_cpls},
   {"@6 ARE TANDEM @b TWOSOME",              concept_some_are_frac_tandem,  F+D, l_c4,
    UC_none, 0, 0,                    0x120, tandem_key_tand},
   {"@6 ARE COUPLES OF 3 @b THREESOME",      concept_some_are_frac_tandem,  F+D, l_c4,
    UC_none, 0, 0,                    0x120, tandem_key_cpls3},
   {"@6 ARE TANDEMS OF 3 @b THREESOME",      concept_some_are_frac_tandem,  F+D, l_c4,
    UC_none, 0, 0,                    0x120, tandem_key_tand3},
   {"INSIDE TRIANGLES ARE SOLID @b THREESOME",       concept_frac_tandem,   F+D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_inside_tgls},
   {"OUTSIDE TRIANGLES ARE SOLID @b THREESOME",      concept_frac_tandem,   F+D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_outside_tgls},
   {"IN POINT TRIANGLES ARE SOLID @b THREESOME",     concept_frac_tandem,   F+D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_inpoint_tgls},
   {"OUT POINT TRIANGLES ARE SOLID @b THREESOME",    concept_frac_tandem,   F+D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_outpoint_tgls},
   {"WAVE-BASED TRIANGLES ARE SOLID @b THREESOME",   concept_frac_tandem,   F+D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_wave_tgls},
   {"TANDEM-BASED TRIANGLES ARE SOLID @b THREESOME", concept_frac_tandem,   F+D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_tand_tgls},
   {"@k-BASED TRIANGLES ARE SOLID @b THREESOME", concept_some_are_frac_tandem,F+D,l_c4,
    UC_none, 0, 0,                    0x120, tandem_key_anyone_tgls},
   {"3X1 TRIANGLES ARE SOLID @b TRIANGLESOME",       concept_frac_tandem,   F+D, l_c4,
    UC_none, 0, 0,                    0x020, tandem_key_3x1tgls},
   {"Y's ARE SOLID @b Y-SOME",                       concept_frac_tandem,   F+D, l_c4,
   ...
   {"@6 ARE COUPLES TWOSOME",                concept_some_are_tandem,       F+D, l_c3,
    UC_none, 0, 0,                    0x110, tandem_key_cpls},
   {"@6 ARE TANDEM TWOSOME",                 concept_some_are_tandem,       F+D, l_c3,
    UC_none, 0, 0,                    0x110, tandem_key_tand},
   {"@6 ARE COUPLES THREESOME",              concept_some_are_tandem,       F+D, l_c3,
    UC_none, 0, 0,                    0x110, tandem_key_cpls3},
   {"@6 ARE TANDEM THREESOME",               concept_some_are_tandem,       F+D, l_c3,
   ...
   {"COUPLES TWOSOME @b SOLID",              concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_cpls},
   {"TANDEM TWOSOME @b SOLID",               concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_tand},
   {"SIAMESE TWOSOME @b SOLID",              concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_siam},
   {"COUPLES THREESOME @b SOLID",            concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_cpls3},
   {"TANDEM THREESOME @b SOLID",             concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_tand3},
   {"SIAMESE THREESOME @b SOLID",            concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_siam3},
   {"COUPLES FOURSOME @b SOLID",             concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_cpls4},
   {"TANDEM FOURSOME @b SOLID",              concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_tand4},
   {"SIAMESE FOURSOME @b SOLID",             concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_siam4},
   {"BOXSOME @b SOLID",                      concept_frac_tandem,           F+D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_box},
   {"DIAMONDSOME @b SOLID",                  concept_frac_tandem,           F+D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_diamond},
   {"SKEWSOME @b SOLID",                     concept_frac_tandem,             D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_skew},
   {"GRUESOME TWOSOME @b SOLID",             concept_gruesome_frac_tandem,    D, l_c4,
    UC_none, 0, CONCPROP__NEEDK_2X8,  0x032, tandem_key_cpls},
   {"GRUESOME TANDEM TWOSOME @b SOLID",      concept_gruesome_frac_tandem,    D, l_c4,
    UC_none, 0, CONCPROP__NEEDK_2X8,  0x032, tandem_key_tand},
   {"@6 ARE COUPLES TWOSOME @b SOLID",       concept_some_are_frac_tandem,  F+D, l_c4,
    UC_none, 0, 0,                    0x130, tandem_key_cpls},
   {"@6 ARE TANDEM TWOSOME @b SOLID",        concept_some_are_frac_tandem,  F+D, l_c4,
    UC_none, 0, 0,                    0x130, tandem_key_tand},
   {"@6 ARE COUPLES THREESOME @b SOLID",     concept_some_are_frac_tandem,  F+D, l_c4,
    UC_none, 0, 0,                    0x130, tandem_key_cpls3},
   {"@6 ARE TANDEM THREESOME @b SOLID",      concept_some_are_frac_tandem,  F+D, l_c4,
    UC_none, 0, 0,                    0x130, tandem_key_tand3},
   {"INSIDE TRIANGLES ARE THREESOME @b SOLID",       concept_frac_tandem,   F+D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_inside_tgls},
   {"OUTSIDE TRIANGLES ARE THREESOME @b SOLID",      concept_frac_tandem,   F+D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_outside_tgls},
   {"IN POINT TRIANGLES ARE THREESOME @b SOLID",     concept_frac_tandem,   F+D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_inpoint_tgls},
   {"OUT POINT TRIANGLES ARE THREESOME @b SOLID",    concept_frac_tandem,   F+D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_outpoint_tgls},
   {"WAVE-BASED TRIANGLES ARE THREESOME @b SOLID",   concept_frac_tandem,   F+D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_wave_tgls},
   {"TANDEM-BASED TRIANGLES ARE THREESOME @b SOLID", concept_frac_tandem,   F+D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_tand_tgls},
   {"@k-BASED TRIANGLES ARE THREESOME @b SOLID", concept_some_are_frac_tandem,F+D,l_c4,
    UC_none, 0, 0,                    0x130, tandem_key_anyone_tgls},
   {"3X1 TRIANGLES ARE TRIANGLESOME @b SOLID",       concept_frac_tandem,   F+D, l_c4,
    UC_none, 0, 0,                    0x030, tandem_key_3x1tgls},
   {"Y-SOME @b SOLID",                               concept_frac_tandem,   F+D, l_c4,
   ...
   {"TRIPLE COLUMNS",                        concept_multiple_lines,          D, l_c2,
    UC_tc, 0, CONCPROP__NEEDK_TRIPLE_1X4, 0, 3, MPKIND__SPLIT},
   {"TRIPLE LINES",                          concept_multiple_lines,          D, l_c2,
    UC_tl, 1, CONCPROP__NEEDK_TRIPLE_1X4, 0, 3, MPKIND__SPLIT},
   {"TRIPLE WAVES",                          concept_multiple_lines,          D, l_c2,
   ...
   {"TRIPLE DIAMONDS",                       concept_triple_diamonds,         D, l_c3a,
    UC_td, 0, 0, CMD_MISC__VERIFY_DMD_LIKE, 0, MPKIND__SPLIT},
   {"TRIPLE DIAMOND SPOTS",                  concept_triple_diamonds,         D, l_c3a,
    UC_none, 0, 0, 0, 0, MPKIND__SPLIT},
   {"TRIPLE 1/4 TAGS",                       concept_triple_diamonds,         D, l_c3x,
    UC_none, 0, 0, CMD_MISC__VERIFY_1_4_TAG, 0, MPKIND__SPLIT},
   {"TRIPLE 3/4 TAGS",                       concept_triple_diamonds,         D, l_c3x,
    UC_none, 0, 0, CMD_MISC__VERIFY_3_4_TAG, 0, MPKIND__SPLIT},
   {"TRIPLE 1/4 LINES",                      concept_triple_diamonds,         D, l_c3x,
    UC_none, 0, 0, CMD_MISC__VERIFY_REAL_1_4_LINE, 0, MPKIND__SPLIT},
   {"TRIPLE 3/4 LINES",                      concept_triple_diamonds,         D, l_c3x,
    UC_none, 0, 0, CMD_MISC__VERIFY_REAL_3_4_LINE, 0, MPKIND__SPLIT},
   {"TRIPLE GENERAL 1/4 TAGS",               concept_triple_diamonds,         D, l_c3x,
    UC_none, 0, 0, CMD_MISC__VERIFY_QTAG_LIKE, 0, MPKIND__SPLIT},
   ...
   {"QUADRUPLE DIAMONDS",                    concept_quad_diamonds,           D, l_c4a,
    UC_qd, 0, CMD_MISC__VERIFY_DMD_LIKE},
   {"QUADRUPLE DIAMOND SPOTS",               concept_quad_diamonds,           D, l_c4a,
    UC_none, 0, 0},
   {"QUADRUPLE 1/4 TAGS",                    concept_quad_diamonds,           D, l_c4a,
    UC_none, 0, CMD_MISC__VERIFY_1_4_TAG},
   {"QUADRUPLE 3/4 TAGS",                    concept_quad_diamonds,           D, l_c4a,
    UC_none, 0, CMD_MISC__VERIFY_3_4_TAG},
   {"QUADRUPLE 1/4 LINES",                   concept_quad_diamonds,           D, l_c4a,
    UC_none, 0, CMD_MISC__VERIFY_REAL_1_4_LINE},
   {"QUADRUPLE 3/4 LINES",                   concept_quad_diamonds,           D, l_c4a,
    UC_none, 0, CMD_MISC__VERIFY_REAL_3_4_LINE},
   {"QUADRUPLE GENERAL 1/4 TAGS",            concept_quad_diamonds,           D, l_c4a,
   ...
   {"TRIPLE COLUMNS WORKING RIGHT",          concept_multiple_lines_tog,      D, l_c4a,
    UC_tcwr, 2,  CONCPROP__NEEDK_TRIPLE_1X4, 0, 3},
   {"TRIPLE COLUMNS WORKING LEFT",           concept_multiple_lines_tog,      D, l_c4a,
   ...
   {"TRIPLE BOXES WORKING TOGETHER",         concept_triple_boxes_together,   D, l_c4a,
    UC_tbwt, 6, 0},
   {"TRIPLE BOXES WORKING APART",            concept_triple_boxes_together,   D, l_c4a,
    UC_tbwa, 7, 0},
   {"TRIPLE BOXES WORKING FORWARD",          concept_triple_boxes_together,   D, l_c4a,
    UC_tbwf, 0, 0},
   {"TRIPLE BOXES WORKING BACKWARD",         concept_triple_boxes_together,   D, l_c4a,
    UC_tbwb, 2, 0},
   {"TRIPLE BOXES WORKING RIGHT",            concept_triple_boxes_together,   D, l_c4a,
    UC_tbwr, 3, 0},
   {"TRIPLE BOXES WORKING LEFT",             concept_triple_boxes_together,   D, l_c4a,
    UC_tbwl, 1, 0},
   ...
   {"CENTER TRIPLE COLUMN",                  concept_in_out_std,              D, l_c2,
    UC_none, 0, CONCPROP__NEEDK_CTR_1X4, 0},
   {"OUTSIDE TRIPLE COLUMNS",                concept_in_out_std,              D, l_c2,
    UC_none, 8+0, CONCPROP__NEEDK_END_1X4, 0},
   {"CENTER TRIPLE LINE",                    concept_in_out_std,              D, l_c2,
    UC_none, 1, CONCPROP__NEEDK_CTR_1X4, 0},
   {"OUTSIDE TRIPLE LINES",                  concept_in_out_std,              D, l_c2,
    UC_none, 8+1, CONCPROP__NEEDK_END_1X4, 0},
   {"CENTER TRIPLE WAVE",                    concept_in_out_std,              D, l_c2,
    UC_none, 3, CONCPROP__NEEDK_CTR_1X4, 0},
   {"OUTSIDE TRIPLE WAVES",                  concept_in_out_std,              D, l_c2,
   ...
   {"CENTER TRIPLE DIAMOND",                 concept_in_out_nostd,            D, l_c3a,
    UC_none, 5, CONCPROP__NEEDK_CTR_DMD, 0},
   {"OUTSIDE TRIPLE DIAMONDS",               concept_in_out_nostd,            D, l_c3a,
    UC_none, 8+5, CONCPROP__NEEDK_END_DMD, 0},
   ...
   {"CENTER PHANTOM COLUMNS",                concept_in_out_std,              D, l_c3a,
    UC_none, 16+0,   CONCPROP__NEEDK_QUAD_1X4, 0},
   {"OUTSIDE PHANTOM COLUMNS",               concept_in_out_std,              D, l_c3a,
   ...
   {"12 MATRIX CENTER PHANTOM COLUMNS",      concept_in_out_std,              D, l_c3x,
    UC_none, 64+0,   0, 0},
   {"12 MATRIX OUTSIDE PHANTOM COLUMNS",     concept_in_out_std,              D, l_c3x,
    UC_none, 64+8+0, 0, 0},
   {"12 MATRIX CENTER PHANTOM LINES",        concept_in_out_std,              D, l_c3x,
    UC_none, 64+1, 0, 0},
   {"12 MATRIX OUTSIDE PHANTOM LINES",       concept_in_out_std,              D, l_c3x,
    UC_none, 64+8+1, 0, 0},
   {"TWIN PHANTOM DIAMONDS",                 concept_do_divided_diamonds,     D, l_c3x,
    UC_none, phantest_impossible, CONCPROP__NEEDK_TWINDMD, CMD_MISC__VERIFY_DMD_LIKE, 0},
   {"TWIN PHANTOM DIAMOND SPOTS",            concept_do_divided_diamonds,     D, l_c3x,
    UC_none, phantest_impossible, CONCPROP__NEEDK_4X6, 0, 0},
   {"TWIN PHANTOM 1/4 TAGS",                 concept_do_divided_diamonds,     D, l_c3x,
    UC_none, phantest_impossible, CONCPROP__NEEDK_TWINQTAG, CMD_MISC__VERIFY_1_4_TAG, 0},
   {"TWIN PHANTOM 3/4 TAGS",                 concept_do_divided_diamonds,     D, l_c3x,
    UC_none, phantest_impossible, CONCPROP__NEEDK_TWINQTAG, CMD_MISC__VERIFY_3_4_TAG, 0},
   {"TWIN PHANTOM 1/4 LINES",                concept_do_divided_diamonds,     D, l_c3x,
    UC_none, phantest_impossible, CONCPROP__NEEDK_TWINQTAG, CMD_MISC__VERIFY_REAL_1_4_LINE,0},
   {"TWIN PHANTOM 3/4 LINES",                concept_do_divided_diamonds,     D, l_c3x,
    UC_none, phantest_impossible, CONCPROP__NEEDK_TWINQTAG, CMD_MISC__VERIFY_REAL_3_4_LINE,0},
   {"TWIN PHANTOM GENERAL 1/4 TAGS",         concept_do_divided_diamonds,     D, l_c3x,
    UC_none, phantest_impossible, CONCPROP__NEEDK_TWINQTAG, CMD_MISC__VERIFY_QTAG_LIKE, 0},
   {"TWIN PHANTOM POINT-TO-POINT DIAMONDS",  concept_do_divided_diamonds,     D, l_c4,
   ...
   {"TWIN PHANTOM BONES",                    concept_do_divided_bones,        D, l_c3x,
    UC_none, phantest_impossible, 0, 0, 0},
   {"TWIN PHANTOM BATS",                     concept_do_divided_bones,        D, l_c3x,
   ...
   {"BIG BLOCK",                             concept_do_phantom_2x4,          D, l_c3a,
    UC_none, phantest_only_one, 1, MPKIND__STAG, 0},
   {"STAIRSTEP LINES",                       concept_do_phantom_2x4,          D, l_c4,
    UC_none, phantest_only_one, 1, MPKIND__NONE, spcmap_ladder},
   {"LADDER LINES",                          concept_do_phantom_2x4,          D, l_c4,
    UC_none, phantest_only_one, 1, MPKIND__NONE, spcmap_stairst},
   {"OFFSET LINES",                          concept_distorted,               D, l_c2,
    UC_none, disttest_offset, 1, 0, 0},
   {"OFFSET LINE",                           concept_distorted,               D, l_c2,
    UC_none, disttest_offset, 1, 0, 1},
   {"Z LINES",                               concept_distorted,               D, l_c4a,
    UC_none, disttest_z, 1, 0, 0},
   {"DISTORTED LINES",                       concept_distorted,               D, l_c3,
    UC_none, disttest_any, 1, 0, 0},
   ...
   {"PHANTOM BIG BLOCK LINES",               concept_do_phantom_2x4,          D, l_c4,
    UC_none, phantest_both, 1, MPKIND__STAG, 0},
   {"PHANTOM STAIRSTEP LINES",               concept_do_phantom_2x4,          D, l_c4,
    UC_none, phantest_both, 1, MPKIND__NONE, spcmap_ladder},
   {"PHANTOM LADDER LINES",                  concept_do_phantom_2x4,          D, l_c4,
    UC_none, phantest_both, 1, MPKIND__NONE, spcmap_stairst},
   {"PHANTOM OFFSET LINES",                  concept_do_phantom_2x4,          D, l_c4a,
    UC_pofl, phantest_both, 1, MPKIND__OFFS_BOTH_FULL, 0},
   ...
   {"OFFSET 1/4 TAG",                        concept_distorted,               D, l_c4,
    UC_none, disttest_any, 256, CMD_MISC__VERIFY_1_4_TAG},
   {"OFFSET 3/4 TAG",                        concept_distorted,               D, l_c4,
    UC_none, disttest_any, 256, CMD_MISC__VERIFY_3_4_TAG},
   ...
   {"DIAGONAL GENERAL 1/4 TAG",              concept_do_phantom_diag_qtg,     D, l_c4,
    UC_none, phantest_only_one, 0, CMD_MISC__VERIFY_QTAG_LIKE},
   {"DISTORTED DIAMONDS",                    concept_distorted,               D, l_c3x,
    UC_none, disttest_any, 16, CMD_MISC__VERIFY_DMD_LIKE},
   {"DISTORTED 1/4 TAG",                     concept_distorted,               D, l_c3x,
    UC_none, disttest_any, 16, CMD_MISC__VERIFY_1_4_TAG},
   {"DISTORTED 3/4 TAG",                     concept_distorted,               D, l_c3x,
    UC_none, disttest_any, 16, CMD_MISC__VERIFY_3_4_TAG},
   {"DISTORTED 1/4 LINE",                    concept_distorted,               D, l_c3x,
    UC_none, disttest_any, 16, CMD_MISC__VERIFY_REAL_1_4_LINE},
   {"DISTORTED 3/4 LINE",                    concept_distorted,               D, l_c3x,
    UC_none, disttest_any, 16, CMD_MISC__VERIFY_REAL_3_4_LINE},
   {"DISTORTED GENERAL 1/4 TAG",             concept_distorted,               D, l_c3x,
    UC_none, disttest_any, 16, CMD_MISC__VERIFY_QTAG_LIKE},
   {"DISTORTED DIAMOND SPOTS",               concept_distorted,               D, l_c3x,
    UC_none, disttest_any, 16, 0},
   {"BIG BLOCK WAVES",                       concept_do_phantom_2x4,          D, l_c3a,
    UC_none, phantest_only_one, 3, MPKIND__STAG, 0},
   {"STAIRSTEP WAVES",                       concept_do_phantom_2x4,          D, l_c4,
    UC_none, phantest_only_one, 3, MPKIND__NONE, spcmap_ladder},
   {"LADDER WAVES",                          concept_do_phantom_2x4,          D, l_c4,
    UC_none, phantest_only_one, 3, MPKIND__NONE, spcmap_stairst},
   {"OFFSET WAVES",                          concept_distorted,               D, l_c2,
    UC_none, disttest_offset, 3, 0, 0},
   {"OFFSET WAVE",                           concept_distorted,               D, l_c2,
    UC_none, disttest_offset, 3, 0, 1},
   {"Z WAVES",                               concept_distorted,               D, l_c4a,
    UC_none, disttest_z, 3, 0, 0},
   {"DISTORTED WAVES",                       concept_distorted,               D, l_c3,
    UC_none, disttest_any, 3, 0, 0},
   ...
   {"PHANTOM BIG BLOCK WAVES",               concept_do_phantom_2x4,          D, l_c4,
    UC_none, phantest_both, 3, MPKIND__STAG, 0},
   {"PHANTOM STAIRSTEP WAVES",               concept_do_phantom_2x4,          D, l_c4,
    UC_none, phantest_both, 3, MPKIND__NONE, spcmap_ladder},
   {"PHANTOM LADDER WAVES",                  concept_do_phantom_2x4,          D, l_c4,
    UC_none, phantest_both, 3, MPKIND__NONE, spcmap_stairst},
   {"PHANTOM OFFSET WAVES",                  concept_do_phantom_2x4,          D, l_c4a,
    UC_none, phantest_both, 3, MPKIND__OFFS_BOTH_FULL, 0},
   ...
   {"STAGGER",                               concept_do_phantom_2x4,          D, l_c2,
    UC_none, phantest_only_one, 0, MPKIND__STAG, 0},
   {"STAIRSTEP COLUMNS",                     concept_do_phantom_2x4,          D, l_c4,
    UC_none, phantest_only_one, 0, MPKIND__NONE, spcmap_stairst},
   {"LADDER COLUMNS",                        concept_do_phantom_2x4,          D, l_c4,
    UC_none, phantest_only_one, 0, MPKIND__NONE, spcmap_ladder},
   {"OFFSET COLUMNS",                        concept_distorted,               D, l_c2,
    UC_none, disttest_offset, 0, 0, 0},
   {"OFFSET COLUMN",                         concept_distorted,               D, l_c2,
    UC_none, disttest_offset, 0, 0, 1},
   {"Z COLUMNS",                             concept_distorted,               D, l_c4a,
    UC_none, disttest_z, 0, 0, 0},
   {"DISTORTED COLUMNS",                     concept_distorted,               D, l_c3,
    UC_none, disttest_any, 0, 0, 0},
   ...
   {"PHANTOM STAGGER COLUMNS",               concept_do_phantom_2x4,          D, l_c4,
    UC_none, phantest_both, 0, MPKIND__STAG, 0},
   {"PHANTOM STAIRSTEP COLUMNS",             concept_do_phantom_2x4,          D, l_c4,
    UC_none, phantest_both, 0, MPKIND__NONE, spcmap_stairst},
   {"PHANTOM LADDER COLUMNS",                concept_do_phantom_2x4,          D, l_c4,
    UC_none, phantest_both, 0, MPKIND__NONE, spcmap_ladder},
   {"PHANTOM OFFSET COLUMNS",                concept_do_phantom_2x4,          D, l_c4a,
    UC_pofc, phantest_both, 0, MPKIND__OFFS_BOTH_FULL, 0},
   {"O",                                     concept_do_phantom_2x4,          D, l_c1,
    UC_none, phantest_only_first_one, 0, MPKIND__O_SPOTS, 0},
   {"BUTTERFLY",                             concept_do_phantom_2x4,          D, l_c1,
    UC_none, phantest_only_second_one, 0, MPKIND__X_SPOTS, 0},
   {"PHANTOM BUTTERFLY OR O",                concept_do_phantom_2x4,          D, l_c4a,
    UC_pob, phantest_both, 0, MPKIND__NONE, spcmap_but_o},
   ...
   {"ONCE REMOVED",                          concept_once_removed,            D, l_c2,
    UC_none, 0},
   {"TWICE REMOVED",                         concept_once_removed,            D, l_c3x,
    UC_none, 2},
   {"THRICE REMOVED",                        concept_once_removed,            D, l_c3x,
    UC_none, 3},
   ...
   {"BACK-TO-BACK PARALLELOGRAM",            concept_misc_distort,            D, l_c3a,
    UC_none, 4, 0, 16},
   {"BLOCKS",                                concept_do_phantom_2x2,          D, l_c1,
    UC_none, spcmap_blocks, phantest_2x2_only_two},
   {"IN YOUR BLOCKS",                        concept_do_phantom_2x2,          D, l_c1,
    UC_none, spcmap_blocks, phantest_2x2_only_two},
   {"4 PHANTOM INTERLOCKED BLOCKS",          concept_do_phantom_2x2,          D, l_c4a,
   ...
   {"@6 WORK",                               concept_so_and_so_only,        L+D, l_c1,
   ...
   {"ODDLY",                                 concept_meta,                  G+D, l_c4,
    UC_none, meta_key_random},
   {"EVENLY",                                concept_meta,                  G+D, l_c4,
    UC_none, meta_key_rev_random},
   {"PIECEWISE",                             concept_meta,                  G+D, l_c3x,
   ...
   {"LIKE AN",                               concept_meta,                    D, l_c1,
    UC_none, meta_key_like_a},
   {"ECHO",                                  concept_meta,                  G+D, l_c4,
    UC_none, meta_key_echo},
   {"REVERSE ECHO",                          concept_meta,                  G+D, l_c4,
    UC_none, meta_key_rev_echo},
   ...
   {"INTERRUPT AFTER @9/@9",                 concept_interrupt_at_fraction,   0, l_c1,
    UC_none, 2},
   {"SANDWICH",                              concept_sandwich,                0, l_c3,
    UC_none, 3},
   ...
   {"OUT POINT TRIANGLES",                   concept_randomtrngl,             D, l_c1,
    UC_none, 4},
   {"TALL 6",                                concept_randomtrngl,             D, l_c3x,
    UC_none, 0},
   {"SHORT 6",                               concept_randomtrngl,             D, l_c3x,
    UC_none, 1},
   ...
   {"@6 ARE CENTERS OF DOUBLE-OFFSET DIAMOND SPOTS",concept_double_offset,    D, l_c4,
    UC_none, 4},
   {"INRIGGER",                              concept_rigger,                  D, l_c3x,
    UC_none, 2},
   {"OUTRIGGER",                             concept_rigger,                  D, l_c3x,
    UC_none, 0},
   {"LEFTRIGGER",                            concept_rigger,                  D, l_c3x,
    UC_none, 1},
   {"RIGHTRIGGER",                           concept_rigger,                  D, l_c3x,
    UC_none, 3},
   {"BACKRIGGER",                            concept_rigger,                  D, l_c3x,
    UC_none, 16},
   {"FRONTRIGGER",                           concept_rigger,                  D, l_c3x,
    UC_none, 18},
   {"RIGHT WING",                            concept_wing,                    D, l_c3x,
    UC_none, 0},
   ...
   {"ALL 8 (diamonds)",                      concept_all_8,                   D, l_a2,
    UC_none, 2},
   {"REVERT",                                concept_revert,                L+D, l_c3x,
