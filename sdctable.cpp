...
conzept::concept_descriptor conzept::unsealed_concept_descriptor_table[] = {
   ...
   {"QUADRUPLE LINES",                       concept_quad_lines,              D, l_c4a,
    UC_none, 1, 0},
   {"QUADRUPLE WAVES",                       concept_quad_lines,              D, l_c4a,
    UC_none, 3, 0},
   {"QUADRUPLE BOXES",                       concept_quad_boxes,              D, l_c4a,
    UC_none, MPKIND__SPLIT},
   ...
   {"QUADRUPLE COLUMNS OF 3",                concept_quad_lines_of_3,         D, l_c4a,
    UC_none, 0, 1},
   {"QUADRUPLE LINES OF 3",                  concept_quad_lines_of_3,         D, l_c4a,
    UC_none, 1, 1},
   {"QUADRUPLE WAVES OF 3",                  concept_quad_lines_of_3,         D, l_c4a,
    UC_none, 3, 1},
