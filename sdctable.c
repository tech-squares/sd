...
#define pl__1_qlwb 35
   ...
   {"CENTER TRIPLE LINE",                    concept_in_out_line_3,             D, l_c2, {0, 1, CONCPROP__NEED_CTR_1X4}},
   {"OUTSIDE TRIPLE LINES",                  concept_in_out_line_3,             D, l_c2, {0, 8+1, CONCPROP__NEED_END_1X4}},
   ...
   {"CENTER PHANTOM LINES",                  concept_in_out_line_4,             D, l_c3,  {0, 16+1, CONCPROP__NEEDK_4X4_1X16}},
   {"OUTSIDE PHANTOM LINES",                 concept_in_out_line_4,             D, l_c3,  {0, 16+8+1, CONCPROP__NEEDK_4X4_1X16}},
...
#define pl__2_pw 2
   ...
   {"CENTER TRIPLE WAVE",                    concept_in_out_line_3,             D, l_c2, {0, 3, CONCPROP__NEED_CTR_1X4}},
   {"OUTSIDE TRIPLE WAVES",                  concept_in_out_line_3,             D, l_c2, {0, 8+3, CONCPROP__NEED_END_1X4}},
   ...
   {"CENTER PHANTOM WAVES",                  concept_in_out_line_4,             D, l_c3,  {0, 16+3, CONCPROP__NEEDK_4X4_1X16}},
   {"OUTSIDE PHANTOM WAVES",                 concept_in_out_line_4,             D, l_c3,  {0, 16+8+3, CONCPROP__NEEDK_4X4_1X16}},
...
#define pl__3_qcwl 35
   ...
   {"CENTER TRIPLE COLUMN",                  concept_in_out_line_3,             D, l_c3, {0, 0, CONCPROP__NEED_CTR_1X4}},
   {"OUTSIDE TRIPLE COLUMNS",                concept_in_out_line_3,             D, l_c3, {0, 8+0, CONCPROP__NEED_END_1X4}},
   ...
   {"CENTER PHANTOM COLUMNS",                concept_in_out_line_4,             D, l_c3a, {0, 16+0, CONCPROP__NEEDK_4X4_1X16}},
   {"OUTSIDE PHANTOM COLUMNS",               concept_in_out_line_4,             D, l_c3a, {0, 16+8+0, CONCPROP__NEEDK_4X4_1X16}},
...
#define pb__1_qbwl 38
   ...
   {"CENTER TRIPLE BOX",                     concept_in_out_box_3,              D, l_c1, {0, 4, CONCPROP__NEED_CTR_2X2}},
   {"OUTSIDE TRIPLE BOXES",                  concept_in_out_box_3,              D, l_c1, {0, 8+4, CONCPROP__NEED_END_2X2}},
   ...
   {"CENTER PHANTOM BOXES",                  concept_in_out_box_4,              D, l_c4a, {0, 16+4, CONCPROP__NEEDK_2X8}},
   {"OUTSIDE PHANTOM BOXES",                 concept_in_out_box_4,              D, l_c4a, {0, 16+8+4, CONCPROP__NEEDK_2X8}},
...
#define mm__1_phan 12
   ...
   {"ASSUME MINIWAVES",                      concept_assume_waves,              D, l_c3,         {0, cr_wave_only,  2, 0}},
