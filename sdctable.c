...
#define pl__1_pl6 11
#define pl__1_tl 17
#define pl__1_tlwt 20
#define pl__1_tlwa 21
#define pl__1_tlwf 22
#define pl__1_tlwb 23
#define pl__1_trtl 31
#define pl__1_qlwt 36
#define pl__1_qlwa 37
#define pl__1_qlwf 38
#define pl__1_qlwb 39
   ...
   {"CENTER PHANTOM LINES",                  concept_in_out_line_4,             D, l_c3,  {0, 16+1, CONCPROP__NEEDK_4X4_1X16, 0}},
   {"OUTSIDE PHANTOM LINES",                 concept_in_out_line_4,             D, l_c3,  {0, 16+8+1, CONCPROP__NEEDK_4X4_1X16, 0}},
...
#define pl__2_pw 2
   ...
   {"CENTER PHANTOM WAVES",                  concept_in_out_line_4,             D, l_c3,  {0, 16+3, CONCPROP__NEEDK_4X4_1X16, 0}},
   {"OUTSIDE PHANTOM WAVES",                 concept_in_out_line_4,             D, l_c3,  {0, 16+8+3, CONCPROP__NEEDK_4X4_1X16, 0}},
...
#define pl__3_pc6 11
#define pl__3_tc 17
#define pl__3_tcwt 20
#define pl__3_tcwa 21
#define pl__3_tcwr 22
#define pl__3_tcwl 23
#define pl__3_trtc 31
#define pl__3_qcwt 36
#define pl__3_qcwa 37
#define pl__3_qcwr 38
#define pl__3_qcwl 39
   ...
   {"CENTER PHANTOM COLUMNS",                concept_in_out_line_4,             D, l_c3a, {0, 16+0, CONCPROP__NEEDK_4X4_1X16, 0}},
   {"OUTSIDE PHANTOM COLUMNS",               concept_in_out_line_4,             D, l_c3a, {0, 16+8+0, CONCPROP__NEEDK_4X4_1X16, 0}},
...
#define pb__1_qbwl 38
   ...
   {"CENTER PHANTOM BOXES",                  concept_in_out_box_4,              D, l_c4a, {0, 16+4, CONCPROP__NEEDK_2X8, 0}},
   {"OUTSIDE PHANTOM BOXES",                 concept_in_out_box_4,              D, l_c4a, {0, 16+8+4, CONCPROP__NEEDK_2X8, 0}},
...
#define pb__2_qdwt 39
   ...
   {"CENTER PHANTOM DIAMONDS",               concept_in_out_dmd_4,              D, l_c4a, {0, 16+5, CONCPROP__NEEDK_4DMD, CMD_MISC__VERIFY_DMD_LIKE}},
   {"OUTSIDE PHANTOM DIAMONDS",              concept_in_out_dmd_4,              D, l_c4a, {0, 16+8+5, CONCPROP__NEEDK_4DMD, CMD_MISC__VERIFY_DMD_LIKE}},
   {"CENTER PHANTOM DIAMOND SPOTS",          concept_in_out_dmd_4,              D, l_c4a, {0, 16+5, CONCPROP__NEEDK_4DMD, 0}},
   {"OUTSIDE PHANTOM DIAMOND SPOTS",         concept_in_out_dmd_4,              D, l_c4a, {0, 16+8+5, CONCPROP__NEEDK_4DMD, 0}},
...
#define tt__1_tnd 3
   {"PHANTOM",                               concept_c1_phantom,            L+U+D, l_c1},
         {"", concept_comment, 0, l_nonexistent_concept},
   {"AS COUPLES",                            concept_tandem,                    D, l_a1,         {0, FALSE, 0, 0, 1}},
   {"TANDEM",                                concept_tandem,                    D, l_c1,         {0, FALSE, 0, 0, 0}},
   {"SIAMESE",                               concept_tandem,                    D, l_c1,         {0, FALSE, 0, 0, 2}},
   {"COUPLES OF THREE",                      concept_tandem,                    D, l_c1,         {0, FALSE, 0, 0, 5}},
   {"TANDEMS OF THREE",                      concept_tandem,                    D, l_c1,         {0, FALSE, 0, 0, 4}},
   {"COUPLES OF FOUR",                       concept_tandem,                    D, l_c1,         {0, FALSE, 0, 0, 7}},
   {"TANDEMS OF FOUR",                       concept_tandem,                    D, l_c1,         {0, FALSE, 0, 0, 6}},
   ...
   {"@6 ARE TANDEMS OF THREE",               concept_some_are_tandem,         F+D, l_c1,         {0, TRUE,  0, 0, 4}},
   {"INSIDE TRIANGLES WORK SOLID",           concept_tandem,                  F+D, l_c2,         {0, FALSE, 0, 0, 22}},
   {"OUTSIDE TRIANGLES WORK SOLID",          concept_tandem,                  F+D, l_c2,         {0, FALSE, 0, 0, 23}},
   {"IN POINT TRIANGLES WORK SOLID",         concept_tandem,                  F+D, l_c2,         {0, FALSE, 0, 0, 21}},
   {"OUT POINT TRIANGLES WORK SOLID",        concept_tandem,                  F+D, l_c2,         {0, FALSE, 0, 0, 20}},
   {"WAVE-BASED TRIANGLES WORK SOLID",       concept_tandem,                  F+D, l_c2,         {0, FALSE, 0, 0, 26}},
   {"TANDEM-BASED TRIANGLES WORK SOLID",     concept_tandem,                  F+D, l_c2,         {0, FALSE, 0, 0, 27}},
   {"@k-BASED TRIANGLES WORK SOLID",         concept_some_are_tandem,         F+D, l_c2,         {0, TRUE,  0, 0, 30}},
   {"3X1 TRIANGLES WORK SOLID",              concept_tandem,                  F+D, l_c2,         {0, FALSE, 0, 0, 31}},
         {"", concept_comment, 0, l_nonexistent_concept},
   {"COUPLES @b TWOSOME",                    concept_frac_tandem,               D, l_c4,         {0, FALSE, 2, 0, 1}},
   {"TANDEM @b TWOSOME",                     concept_frac_tandem,               D, l_c4,         {0, FALSE, 2, 0, 0}},
   {"SIAMESE @b TWOSOME",                    concept_frac_tandem,               D, l_c4,         {0, FALSE, 2, 0, 2}},
   {"COUPLES OF THREE @b THREESOME",         concept_frac_tandem,               D, l_c4,         {0, FALSE, 2, 0, 5}},
   {"TANDEMS OF THREE @b THREESOME",         concept_frac_tandem,               D, l_c4,         {0, FALSE, 2, 0, 4}},
   {"COUPLES OF FOUR @b FOURSOME",           concept_frac_tandem,               D, l_c4,         {0, FALSE, 2, 0, 7}},
   {"TANDEMS OF FOUR @b FOURSOME",           concept_frac_tandem,               D, l_c4,         {0, FALSE, 2, 0, 6}},
   ...
   {"@6 ARE TANDEMS OF THREE @b THREESOME",  concept_some_are_frac_tandem,    F+D, l_c4,         {0, TRUE,  2, 0, 4}},
   {"INSIDE TRIANGLES WORK SOLID @b THREESOME",       concept_frac_tandem,    F+D, l_c4,         {0, FALSE, 2, 0, 22}},
   {"OUTSIDE TRIANGLES WORK SOLID @b THREESOME",      concept_frac_tandem,    F+D, l_c4,         {0, FALSE, 2, 0, 23}},
   {"IN POINT TRIANGLES WORK SOLID @b THREESOME",     concept_frac_tandem,    F+D, l_c4,         {0, FALSE, 2, 0, 21}},
   {"OUT POINT TRIANGLES WORK SOLID @b THREESOME",    concept_frac_tandem,    F+D, l_c4,         {0, FALSE, 2, 0, 20}},
   {"WAVE-BASED TRIANGLES WORK SOLID @b THREESOME",   concept_frac_tandem,    F+D, l_c4,         {0, FALSE, 2, 0, 26}},
   {"TANDEM-BASED TRIANGLES WORK SOLID @b THREESOME", concept_frac_tandem,    F+D, l_c4,         {0, FALSE, 2, 0, 27}},
...
#define tt__2_tnd2s 3
   ...
   {"SIAMESE TWOSOME",                       concept_tandem,                    D, l_c3,         {0, FALSE, 1, 0, 2}},
   {"COUPLES THREESOME",                     concept_tandem,                    D, l_c3,         {0, FALSE, 1, 0, 5}},
   {"TANDEM THREESOME",                      concept_tandem,                    D, l_c3,         {0, FALSE, 1, 0, 4}},
   {"COUPLES FOURSOME",                      concept_tandem,                    D, l_c3,         {0, FALSE, 1, 0, 7}},
   {"TANDEM FOURSOME",                       concept_tandem,                    D, l_c3,         {0, FALSE, 1, 0, 6}},
   ...
   {"@6 ARE TANDEM THREESOME",               concept_some_are_tandem,         F+D, l_c3,         {0, TRUE,  1, 0, 4}},
   {"INSIDE TRIANGLES WORK THREESOME",       concept_tandem,                  F+D, l_c4a,        {0, FALSE, 1, 0, 22}},
   {"OUTSIDE TRIANGLES WORK THREESOME",      concept_tandem,                  F+D, l_c4a,        {0, FALSE, 1, 0, 23}},
   {"IN POINT TRIANGLES WORK THREESOME",     concept_tandem,                  F+D, l_c4a,        {0, FALSE, 1, 0, 21}},
   {"OUT POINT TRIANGLES WORK THREESOME",    concept_tandem,                  F+D, l_c4a,        {0, FALSE, 1, 0, 20}},
   {"WAVE-BASED TRIANGLES WORK THREESOME",   concept_tandem,                  F+D, l_c4a,        {0, FALSE, 1, 0, 26}},
   {"TANDEM-BASED TRIANGLES WORK THREESOME", concept_tandem,                  F+D, l_c4a,        {0, FALSE, 1, 0, 27}},
   {"@k-BASED TRIANGLES WORK THREESOME",     concept_some_are_tandem,         F+D, l_c4a,        {0, TRUE,  1, 0, 30}},
   {"3X1 TRIANGLES WORK TRIANGLESOME",       concept_tandem,                  F+D, l_c4a,        {0, FALSE, 1, 0, 31}},
         {"", concept_comment, 0, l_nonexistent_concept},
   {"COUPLES TWOSOME @b SOLID",              concept_frac_tandem,               D, l_c4,         {0, FALSE, 3, 0, 1}},
   {"TANDEM TWOSOME @b SOLID",               concept_frac_tandem,               D, l_c4,         {0, FALSE, 3, 0, 0}},
   {"SIAMESE TWOSOME @b SOLID",              concept_frac_tandem,               D, l_c4,         {0, FALSE, 3, 0, 2}},
   {"COUPLES THREESOME @b SOLID",            concept_frac_tandem,               D, l_c4,         {0, FALSE, 3, 0, 5}},
   {"TANDEM THREESOME @b SOLID",             concept_frac_tandem,               D, l_c4,         {0, FALSE, 3, 0, 4}},
   {"COUPLES FOURSOME @b SOLID",             concept_frac_tandem,               D, l_c4,         {0, FALSE, 3, 0, 7}},
   {"TANDEM FOURSOME @b SOLID",              concept_frac_tandem,               D, l_c4,         {0, FALSE, 3, 0, 6}},
   ...
   {"@6 ARE TANDEM THREESOME @b SOLID",      concept_some_are_frac_tandem,    F+D, l_c4,         {0, TRUE,  3, 0, 4}},
   {"INSIDE TRIANGLES WORK THREESOME @b SOLID",       concept_frac_tandem,    F+D, l_c4,         {0, FALSE, 3, 0, 22}},
   {"OUTSIDE TRIANGLES WORK THREESOME @b SOLID",      concept_frac_tandem,    F+D, l_c4,         {0, FALSE, 3, 0, 23}},
   {"IN POINT TRIANGLES WORK THREESOME @b SOLID",     concept_frac_tandem,    F+D, l_c4,         {0, FALSE, 3, 0, 21}},
   {"OUT POINT TRIANGLES WORK THREESOME @b SOLID",    concept_frac_tandem,    F+D, l_c4,         {0, FALSE, 3, 0, 20}},
   {"WAVE-BASED TRIANGLES WORK THREESOME @b SOLID",   concept_frac_tandem,    F+D, l_c4,         {0, FALSE, 3, 0, 26}},
   {"TANDEM-BASED TRIANGLES WORK THREESOME @b SOLID", concept_frac_tandem,    F+D, l_c4,         {0, FALSE, 3, 0, 27}},
   {"@k-BASED TRIANGLES WORK THREESOME @b SOLID", concept_some_are_frac_tandem, F+D, l_c4,       {0, TRUE,  3, 0, 30}},
   {"3X1 TRIANGLES WORK TRIANGLESOMESOME @b SOLID",   concept_frac_tandem,    F+D, l_c4,         {0, FALSE, 3, 0, 31}},

/* distorted concepts */

#define dd__1_size 22
#define dd__1_pofl 21
...
/* -------- column break -------- */
#define dd__3_size 22
#define dd__3_pob 16
#define dd__3_pofc 21
