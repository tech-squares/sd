...
#define pl__1_qlwb 54
   ...
   {"12 MATRIX SPLIT PHANTOM LINES",         concept_do_phantom_2x3,            D, l_c3x, {0, phantest_impossible,    1, MPKIND__SPLIT}},
...
#define pl__2_ipw 1
#define pl__2_pw 2
   {"SPLIT PHANTOM WAVES",                   concept_do_phantom_2x4,            D, l_c3a, {0, phantest_impossible,    3, MPKIND__SPLIT}},
   {"INTERLOCKED PHANTOM WAVES",             concept_do_phantom_2x4,            D, l_c4a, {0, phantest_impossible,    3, MPKIND__INTLK}},
   {"PHANTOM WAVES",                         concept_do_phantom_2x4,            D, l_c3,  {0, phantest_first_or_both, 3, MPKIND__CONCPHAN}},
         {"", concept_comment, 0, l_nonexistent_concept},
         {"", concept_comment, 0, l_nonexistent_concept},
         {"", concept_comment, 0, l_nonexistent_concept},
         {"", concept_comment, 0, l_nonexistent_concept},
...
#define pl__3_qcwl 54
   ...
   {"PHANTOM COLUMNS",                       concept_do_phantom_2x4,            D, l_c3,  {0, phantest_first_or_both, 0, MPKIND__CONCPHAN}},
         {"", concept_comment, 0, l_nonexistent_concept},
   {"12 MATRIX SPLIT PHANTOM COLUMNS",       concept_do_phantom_2x3,            D, l_c3x, {0, phantest_impossible,    0, MPKIND__SPLIT}},
...
#define pb__2_qdwt 39
   {"SPLIT PHANTOM DIAMONDS",                concept_do_phantom_diamonds,       D, l_c3x, {0, phantest_impossible,   CMD_MISC__VERIFY_DMD_LIKE, MPKIND__SPLIT}},
   ...
   {"PHANTOM DIAMONDS",                      concept_do_phantom_diamonds,       D, l_c4, {0, phantest_first_or_both, CMD_MISC__VERIFY_DMD_LIKE, MPKIND__CONCPHAN}},
         {"", concept_comment, 0, l_nonexistent_concept},
   {"SPLIT PHANTOM DIAMOND SPOTS",           concept_do_phantom_diamonds,       D, l_c3x, {0, phantest_impossible,   0, MPKIND__SPLIT}},
...
#define pb__3_ipgt 9
#define pb__3_pgt 10
   {"SPLIT PHANTOM 1/4 TAGS",                concept_do_phantom_diamonds,       D, l_c3x, {0, phantest_impossible,   CMD_MISC__VERIFY_1_4_TAG, MPKIND__SPLIT}},
   ...
   {"PHANTOM 1/4 TAGS",                      concept_do_phantom_diamonds,       D, l_c4, {0, phantest_first_or_both, CMD_MISC__VERIFY_1_4_TAG, MPKIND__CONCPHAN}},
         {"", concept_comment, 0, l_nonexistent_concept},
   {"SPLIT PHANTOM 3/4 TAGS",                concept_do_phantom_diamonds,       D, l_c3x, {0, phantest_impossible,   CMD_MISC__VERIFY_3_4_TAG, MPKIND__SPLIT}},
   ...
   {"PHANTOM 3/4 TAGS",                      concept_do_phantom_diamonds,       D, l_c4, {0, phantest_first_or_both, CMD_MISC__VERIFY_3_4_TAG, MPKIND__CONCPHAN}},
         {"", concept_comment, 0, l_nonexistent_concept},
   {"SPLIT PHANTOM GENERAL 1/4 TAGS",        concept_do_phantom_diamonds,       D, l_c3x, {0, phantest_impossible,   CMD_MISC__VERIFY_QTAG_LIKE, MPKIND__SPLIT}},
   ...
   {"PHANTOM GENERAL 1/4 TAGS",              concept_do_phantom_diamonds,       D, l_c4, {0, phantest_first_or_both, CMD_MISC__VERIFY_QTAG_LIKE, MPKIND__CONCPHAN}},
         {"", concept_comment, 0, l_nonexistent_concept},
   {"SPLIT PHANTOM 1/4 LINES",               concept_do_phantom_diamonds,       D, l_c3x, {0, phantest_impossible,   CMD_MISC__VERIFY_REAL_1_4_LINE, MPKIND__SPLIT}},
   ...
   {"PHANTOM 1/4 LINES",                     concept_do_phantom_diamonds,       D, l_c4, {0, phantest_first_or_both, CMD_MISC__VERIFY_REAL_1_4_LINE, MPKIND__CONCPHAN}},
         {"", concept_comment, 0, l_nonexistent_concept},
   {"SPLIT PHANTOM 3/4 LINES",               concept_do_phantom_diamonds,       D, l_c3x, {0, phantest_impossible,   CMD_MISC__VERIFY_REAL_3_4_LINE, MPKIND__SPLIT}},
...
#define tt__1_tnd 3
   ...
   {"COUPLES OF THREE",                      concept_tandem,                    D, l_c1,         {0, 0, 0,                    0x000, tandem_key_cpls3}},
   {"TANDEMS OF THREE",                      concept_tandem,                    D, l_c1,         {0, 0, 0,                    0x000, tandem_key_tand3}},
   {"SIAMESE OF THREE",                      concept_tandem,                    D, l_c1,         {0, 0, 0,                    0x000, tandem_key_siam3}},
   {"COUPLES OF FOUR",                       concept_tandem,                    D, l_c1,         {0, 0, 0,                    0x000, tandem_key_cpls4}},
   {"TANDEMS OF FOUR",                       concept_tandem,                    D, l_c1,         {0, 0, 0,                    0x000, tandem_key_tand4}},
   {"SIAMESE OF FOUR",                       concept_tandem,                    D, l_c1,         {0, 0, 0,                    0x000, tandem_key_siam4}},
   ...
   {"@6 ARE COUPLES OF THREE",               concept_some_are_tandem,         F+D, l_c1,         {0, 0, 0,                    0x100, tandem_key_cpls3}},
   {"@6 ARE TANDEMS OF THREE",               concept_some_are_tandem,         F+D, l_c1,         {0, 0, 0,                    0x100, tandem_key_tand3}},
   ...
   {"COUPLES OF THREE @b THREESOME",         concept_frac_tandem,               D, l_c4,         {0, 0, 0,                    0x020, tandem_key_cpls3}},
   {"TANDEMS OF THREE @b THREESOME",         concept_frac_tandem,               D, l_c4,         {0, 0, 0,                    0x020, tandem_key_tand3}},
   {"SIAMESE OF THREE @b THREESOME",         concept_frac_tandem,               D, l_c4,         {0, 0, 0,                    0x020, tandem_key_siam3}},
   {"COUPLES OF FOUR @b FOURSOME",           concept_frac_tandem,               D, l_c4,         {0, 0, 0,                    0x020, tandem_key_cpls4}},
   {"TANDEMS OF FOUR @b FOURSOME",           concept_frac_tandem,               D, l_c4,         {0, 0, 0,                    0x020, tandem_key_tand4}},
   {"SIAMESE OF FOUR @b FOURSOME",           concept_frac_tandem,               D, l_c4,         {0, 0, 0,                    0x020, tandem_key_siam4}},
   ...
   {"@6 ARE COUPLES OF THREE @b THREESOME",  concept_some_are_frac_tandem,    F+D, l_c4,         {0, 0, 0,                    0x120, tandem_key_cpls3}},
   {"@6 ARE TANDEMS OF THREE @b THREESOME",  concept_some_are_frac_tandem,    F+D, l_c4,         {0, 0, 0,                    0x120, tandem_key_tand3}},
...
#define dd__2_size 25
   ...
   {"@6 IN YOUR DISTORTED WAVE",             concept_so_and_so_only,            D, l_c1,         {0, selective_key_disc_dist, 0, 3}},
         {"", concept_comment, 0, l_nonexistent_concept},
   {"@6 IN YOUR DISTORTED BOX",              concept_so_and_so_only,            D, l_c1,         {0, selective_key_disc_dist, 0, 4}},
   {"@6 IN YOUR DISTORTED DIAMOND",          concept_so_and_so_only,            D, l_c1,         {0, selective_key_disc_dist, 0, 5}},
   {"@6 IN YOUR Z",                          concept_so_and_so_only,            D, l_c3,         {0, selective_key_disc_dist, 0, 6}},
         {"", concept_comment, 0, l_nonexistent_concept},
...
#define dd__3_pofc 24
   ...
   {"@6 IN YOUR DISTORTED COLUMN",           concept_so_and_so_only,            D, l_c1,         {0, selective_key_disc_dist, 0, 2}},
         {"", concept_comment, 0, l_nonexistent_concept},
   {"O",                                     concept_do_phantom_2x4,            D, l_c1,         {0, phantest_only_first_one, 0, MPKIND__O_SPOTS}},
...
#define d4__3_size 10
   ...
   {"FRONT JAY",                             concept_misc_distort,              D, l_c4a,        {0, 1, 0, 0,  0x0000}},
   {"BACK JAY",                              concept_misc_distort,              D, l_c4a,        {0, 1, 0, 0,  0xAAAA}},
   {"LEFT JAY",                              concept_misc_distort,              D, l_c4a,        {0, 1, 0, 0,  0x5555}},
   {"RIGHT JAY",                             concept_misc_distort,              D, l_c4a,        {0, 1, 0, 0,  0xFFFF}},
...
#define mm__2_size 78
   ...
   {"SHIFTY",             concept_meta,       D, l_c4,      {0, meta_key_shifty}},
   {"SHIFT @9",           concept_meta_one_arg,F+D,l_c4,    {0, meta_key_shift_n}},
   {"SHIFT 1/2",          concept_meta,     F+D, l_c4,      {0, meta_key_shift_half}},
   {"SHIFT @9-1/2",       concept_meta_one_arg,F+D,l_c4,    {0, meta_key_shift_n_half}},
